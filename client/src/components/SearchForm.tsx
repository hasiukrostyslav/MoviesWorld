  ...
  return (
    <>
      ...
      {isFocus &&
        ...
        queryStr.length > 2 && (
          <div
            className={`absolute ${leftPosition} top-14 z-30 ${!isError && !isFetching ? 'grid auto-rows-max gap-x-8 gap-y-4' : 'flex min-h-40  w-fit  items-center justify-center p-2 text-lg dark:text-slate-400'} rounded-md bg-slate-200 p-6 dark:bg-slate-800`}
          >
            {items &&
              !isFetching &&
              !isError &&
